...
class Bot(commands.Bot):
    ...
    async def event_ready(self):
        ...
        #print("screenSize = ", screenSize, "mouseLocation = ", mouseLoc)
        print("bot ready")
#basic twitch setup
#########################################################################################
    ...
    async def tarot(self, ctx: commands.Context):
        ...
        message = card.get('name') + card.get('desc')
        
        await ctx.send(card.get('name')+" ,"+card.get('desc'))
        
        print(ctx.author.name,card)
